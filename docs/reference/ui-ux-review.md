---
title: UI/UX & Information Architecture Review
---
...
1. **Download** (official binaries + verification)
2. **Stake** (PoSV v2, ops, expectations)
3. **Troubleshoot** (triage → decision tree → recipes)
4. **Build** (ReddID + namespaces + schema)
